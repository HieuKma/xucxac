<template>
  <div class="wrapper-popup" v-bind:class="getClassPopup">
    <div class="rule">
      <h3>Luật chơi</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum iure quia facere
        aut. Nostrum fuga accusamus, minima, facilis explicabo minus, blanditiis eos nisi
        culpa optio voluptates cumque ducimus in adipisci.
      </p>
      <button @click="confirm" class="confirm">Đã hiểu</button>
    </div>
  </div>
</template>
